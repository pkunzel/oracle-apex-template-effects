...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(42657556815162020)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1969895337047233707)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1969894782035233706)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1713002718304960193)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42658494700162011)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42658746795162011)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42659093083162010)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42659364505162010)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42659675574162009)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42659971155162009)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42660242825162008)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(42659675574162009)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1969895337047233707)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42660530505162008)
,p_plugin_attribute_id=>wwv_flow_imp.id(42660242825162008)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42660936777162008)
,p_plugin_attribute_id=>wwv_flow_imp.id(42660242825162008)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42661380617162007)
,p_plugin_attribute_id=>wwv_flow_imp.id(42660242825162008)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42661750187162007)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(42660242825162008)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42662047811162007)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42662318351162006)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42662604262162006)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42662911854162006)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42663269265162005)
,p_plugin_attribute_id=>wwv_flow_imp.id(42662911854162006)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42663691559162005)
,p_plugin_attribute_id=>wwv_flow_imp.id(42662911854162006)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42664049949162004)
,p_plugin_attribute_id=>wwv_flow_imp.id(42662911854162006)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42664439031162004)
,p_plugin_attribute_id=>wwv_flow_imp.id(42662911854162006)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42664860721162004)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(42659971155162009)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1969894782035233706)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42665182658162003)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42665451586162003)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42665766590162003)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42666085449162002)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42666379518162002)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42666677168162002)
,p_plugin_attribute_id=>wwv_flow_imp.id(42666379518162002)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42667023647162001)
,p_plugin_attribute_id=>wwv_flow_imp.id(42666379518162002)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42667432183162001)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42667726799162001)
,p_plugin_attribute_id=>wwv_flow_imp.id(42667432183162001)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42668183652162000)
,p_plugin_attribute_id=>wwv_flow_imp.id(42667432183162001)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42668573264162000)
,p_plugin_attribute_id=>wwv_flow_imp.id(42667432183162001)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42668954278162000)
,p_plugin_attribute_id=>wwv_flow_imp.id(42667432183162001)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42669327023161999)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42669647721161999)
,p_plugin_attribute_id=>wwv_flow_imp.id(42669327023161999)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42670003919161998)
,p_plugin_attribute_id=>wwv_flow_imp.id(42669327023161999)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42670408355161998)
,p_plugin_attribute_id=>wwv_flow_imp.id(42669327023161999)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42670816250161998)
,p_plugin_attribute_id=>wwv_flow_imp.id(42669327023161999)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42671233601161997)
,p_plugin_attribute_id=>wwv_flow_imp.id(42669327023161999)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42671601116161997)
,p_plugin_attribute_id=>wwv_flow_imp.id(42669327023161999)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42672007186161997)
,p_plugin_attribute_id=>wwv_flow_imp.id(42669327023161999)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42672455655161996)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42672747891161996)
,p_plugin_attribute_id=>wwv_flow_imp.id(42672455655161996)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42673184188161996)
,p_plugin_attribute_id=>wwv_flow_imp.id(42672455655161996)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42673525934161995)
,p_plugin_attribute_id=>wwv_flow_imp.id(42672455655161996)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42673969213161995)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42674218558161994)
,p_plugin_attribute_id=>wwv_flow_imp.id(42673969213161995)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42674634001161994)
,p_plugin_attribute_id=>wwv_flow_imp.id(42673969213161995)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42675021094161994)
,p_plugin_attribute_id=>wwv_flow_imp.id(42673969213161995)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42675404659161993)
,p_plugin_attribute_id=>wwv_flow_imp.id(42673969213161995)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42675877508161993)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42676122683161992)
,p_plugin_attribute_id=>wwv_flow_imp.id(42675877508161993)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42676503713161992)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42676854778161992)
,p_plugin_attribute_id=>wwv_flow_imp.id(42676503713161992)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42677262957161991)
,p_plugin_attribute_id=>wwv_flow_imp.id(42676503713161992)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42677620439161991)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1713002718304960193)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42677905878161990)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42678244046161990)
,p_plugin_attribute_id=>wwv_flow_imp.id(42677905878161990)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42678673632161989)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42678952243161989)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1851109227263055321)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1851110486783059469)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1554157712367296891)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1837515598588648588)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1838194899318731692)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1851107292196010335)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1851108625586024192)
,p_plugin_id=>wwv_flow_imp.id(42657556815162020)
