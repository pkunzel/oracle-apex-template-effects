...
@@application/shared_components/files/style_apex_template_effects_css.sql
@@application/shared_components/files/style_apex_template_effects_min_css.sql
...
@@application/deployment/install/install_demoproducts.sql
