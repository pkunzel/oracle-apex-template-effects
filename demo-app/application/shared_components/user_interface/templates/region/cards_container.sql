...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42482306689162243)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42482627348162242)
,p_plug_template_id=>wwv_flow_imp.id(42482306689162243)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42482991715162242)
,p_plug_template_id=>wwv_flow_imp.id(42482306689162243)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42483220740162242)
,p_plug_template_id=>wwv_flow_imp.id(42482306689162243)
,p_name=>'Sub Regions'
