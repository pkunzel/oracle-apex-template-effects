...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42514216423162227)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42514508879162227)
,p_plug_template_id=>wwv_flow_imp.id(42514216423162227)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42514876583162227)
,p_plug_template_id=>wwv_flow_imp.id(42514216423162227)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42515192173162227)
,p_plug_template_id=>wwv_flow_imp.id(42514216423162227)
,p_name=>'Button Start'
