...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(42625441056162068)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1842643281485045712)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1842643836497045713)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42626121612162063)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42626475507162063)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42626776473162063)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42627044068162062)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42627380621162062)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(42626776473162063)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1842643836497045713)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42627680067162062)
,p_plugin_attribute_id=>wwv_flow_imp.id(42627380621162062)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42628023330162061)
,p_plugin_attribute_id=>wwv_flow_imp.id(42627380621162062)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42628476246162061)
,p_plugin_attribute_id=>wwv_flow_imp.id(42627380621162062)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42628869987162061)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(42627380621162062)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42629151292162060)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42629437010162060)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42629762450162059)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42630051526162059)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42630340212162059)
,p_plugin_attribute_id=>wwv_flow_imp.id(42630051526162059)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42630731908162058)
,p_plugin_attribute_id=>wwv_flow_imp.id(42630051526162059)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42631185083162058)
,p_plugin_attribute_id=>wwv_flow_imp.id(42630051526162059)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42631504651162058)
,p_plugin_attribute_id=>wwv_flow_imp.id(42630051526162059)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42631990807162057)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(42627044068162062)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1842643281485045712)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42632266582162057)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42632575253162057)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42632863745162057)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42633179060162056)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42633416469162056)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42633792386162056)
,p_plugin_attribute_id=>wwv_flow_imp.id(42633416469162056)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42634190319162055)
,p_plugin_attribute_id=>wwv_flow_imp.id(42633416469162056)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42634507758162055)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42634895906162055)
,p_plugin_attribute_id=>wwv_flow_imp.id(42634507758162055)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42635269003162054)
,p_plugin_attribute_id=>wwv_flow_imp.id(42634507758162055)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42635610787162054)
,p_plugin_attribute_id=>wwv_flow_imp.id(42634507758162055)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42636049433162054)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42636319550162053)
,p_plugin_attribute_id=>wwv_flow_imp.id(42636049433162054)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42636774864162053)
,p_plugin_attribute_id=>wwv_flow_imp.id(42636049433162054)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42637120202162053)
,p_plugin_attribute_id=>wwv_flow_imp.id(42636049433162054)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42637516772162052)
,p_plugin_attribute_id=>wwv_flow_imp.id(42636049433162054)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42637908849162052)
,p_plugin_attribute_id=>wwv_flow_imp.id(42636049433162054)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42638345056162052)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42638655813162051)
,p_plugin_attribute_id=>wwv_flow_imp.id(42638345056162052)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42639030938162051)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1842846888654192341)
,p_plugin_id=>wwv_flow_imp.id(42625441056162068)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
