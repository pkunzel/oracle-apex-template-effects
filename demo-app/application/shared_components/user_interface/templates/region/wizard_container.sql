...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42539492963162215)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42539761874162215)
,p_plug_template_id=>wwv_flow_imp.id(42539492963162215)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42540003490162215)
,p_plug_template_id=>wwv_flow_imp.id(42539492963162215)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42540391374162215)
,p_plug_template_id=>wwv_flow_imp.id(42539492963162215)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42540616216162215)
,p_plug_template_id=>wwv_flow_imp.id(42539492963162215)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42540952760162215)
,p_plug_template_id=>wwv_flow_imp.id(42539492963162215)
