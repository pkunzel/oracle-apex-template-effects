...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(42426099852162279)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42426325393162279)
,p_page_template_id=>wwv_flow_imp.id(42426099852162279)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42426667867162278)
,p_page_template_id=>wwv_flow_imp.id(42426099852162279)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42426950762162278)
,p_page_template_id=>wwv_flow_imp.id(42426099852162279)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42427275089162278)
,p_page_template_id=>wwv_flow_imp.id(42426099852162279)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42427510964162278)
,p_page_template_id=>wwv_flow_imp.id(42426099852162279)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42427835550162278)
,p_page_template_id=>wwv_flow_imp.id(42426099852162279)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42428133615162278)
,p_page_template_id=>wwv_flow_imp.id(42426099852162279)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42428414374162278)
,p_page_template_id=>wwv_flow_imp.id(42426099852162279)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42428792277162278)
,p_page_template_id=>wwv_flow_imp.id(42426099852162279)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42429090167162278)
,p_page_template_id=>wwv_flow_imp.id(42426099852162279)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42429309870162277)
,p_page_template_id=>wwv_flow_imp.id(42426099852162279)
