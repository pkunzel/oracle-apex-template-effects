...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42531701791162219)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42532078652162219)
,p_plug_template_id=>wwv_flow_imp.id(42531701791162219)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42532372673162219)
,p_plug_template_id=>wwv_flow_imp.id(42531701791162219)
,p_name=>'Tabs'
