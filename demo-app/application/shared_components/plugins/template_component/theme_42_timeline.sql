...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(42642127850162045)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2189725077258268993)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2189725632270268994)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42642810889162041)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42643134431162041)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42643477526162040)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42643714470162040)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42644040202162039)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42644343670162039)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42644692572162039)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(42644040202162039)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2189725632270268994)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42644948900162038)
,p_plugin_attribute_id=>wwv_flow_imp.id(42644692572162039)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42645362377162038)
,p_plugin_attribute_id=>wwv_flow_imp.id(42644692572162039)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42645741344162037)
,p_plugin_attribute_id=>wwv_flow_imp.id(42644692572162039)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42646134585162037)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(42644692572162039)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42646441662162036)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42646795019162036)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42647058144162036)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42647342958162035)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42647612345162035)
,p_plugin_attribute_id=>wwv_flow_imp.id(42647342958162035)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42648049560162034)
,p_plugin_attribute_id=>wwv_flow_imp.id(42647342958162035)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42648481749162034)
,p_plugin_attribute_id=>wwv_flow_imp.id(42647342958162035)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42648895742162033)
,p_plugin_attribute_id=>wwv_flow_imp.id(42647342958162035)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42649205028162033)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(42644343670162039)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2189725077258268993)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42649548324162033)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42649840302162032)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42650176504162032)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42650498662162031)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42650710601162031)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42651052653162031)
,p_plugin_attribute_id=>wwv_flow_imp.id(42650710601162031)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42651400580162030)
,p_plugin_attribute_id=>wwv_flow_imp.id(42650710601162031)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42651830137162030)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42652148591162029)
,p_plugin_attribute_id=>wwv_flow_imp.id(42651830137162030)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42652504179162029)
,p_plugin_attribute_id=>wwv_flow_imp.id(42651830137162030)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42652989484162029)
,p_plugin_attribute_id=>wwv_flow_imp.id(42651830137162030)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42653365610162028)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42653629198162028)
,p_plugin_attribute_id=>wwv_flow_imp.id(42653365610162028)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-Timeline--compact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42654054561162027)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1837494977456477580)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1951906340444741181)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2070937587419045622)
,p_plugin_id=>wwv_flow_imp.id(42642127850162045)
,p_name=>'Avatar Link'
