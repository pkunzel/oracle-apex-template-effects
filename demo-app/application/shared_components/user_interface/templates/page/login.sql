...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(42440572666162271)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42440824191162271)
,p_page_template_id=>wwv_flow_imp.id(42440572666162271)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42441109760162271)
,p_page_template_id=>wwv_flow_imp.id(42440572666162271)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42441457276162271)
,p_page_template_id=>wwv_flow_imp.id(42440572666162271)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42441734543162271)
,p_page_template_id=>wwv_flow_imp.id(42440572666162271)
,p_name=>'Body Footer'
