...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42473665058162248)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42473908400162248)
,p_plug_template_id=>wwv_flow_imp.id(42473665058162248)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42474288435162248)
,p_plug_template_id=>wwv_flow_imp.id(42473665058162248)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42474534134162248)
,p_plug_template_id=>wwv_flow_imp.id(42473665058162248)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42474808354162247)
,p_plug_template_id=>wwv_flow_imp.id(42473665058162248)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42475116384162247)
,p_plug_template_id=>wwv_flow_imp.id(42473665058162248)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42475446531162247)
,p_plug_template_id=>wwv_flow_imp.id(42473665058162248)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42475710474162247)
,p_plug_template_id=>wwv_flow_imp.id(42473665058162248)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42476079240162247)
,p_plug_template_id=>wwv_flow_imp.id(42473665058162248)
,p_name=>'Sub Regions'
