...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42534395108162218)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42534601258162218)
,p_plug_template_id=>wwv_flow_imp.id(42534395108162218)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42534918248162217)
,p_plug_template_id=>wwv_flow_imp.id(42534395108162218)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42535242080162217)
,p_plug_template_id=>wwv_flow_imp.id(42534395108162218)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42535512122162217)
,p_plug_template_id=>wwv_flow_imp.id(42534395108162218)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42535877603162217)
,p_plug_template_id=>wwv_flow_imp.id(42534395108162218)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42536179514162217)
,p_plug_template_id=>wwv_flow_imp.id(42534395108162218)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42536416511162217)
,p_plug_template_id=>wwv_flow_imp.id(42534395108162218)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42536766288162217)
,p_plug_template_id=>wwv_flow_imp.id(42534395108162218)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42537083637162217)
,p_plug_template_id=>wwv_flow_imp.id(42534395108162218)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42537386665162217)
,p_plug_template_id=>wwv_flow_imp.id(42534395108162218)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42537619501162217)
,p_plug_template_id=>wwv_flow_imp.id(42534395108162218)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42537916859162216)
,p_plug_template_id=>wwv_flow_imp.id(42534395108162218)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42538261455162216)
,p_plug_template_id=>wwv_flow_imp.id(42534395108162218)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
