...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(42437192798162273)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42437499974162273)
,p_page_template_id=>wwv_flow_imp.id(42437192798162273)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42437782836162273)
,p_page_template_id=>wwv_flow_imp.id(42437192798162273)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42438073228162272)
,p_page_template_id=>wwv_flow_imp.id(42437192798162273)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42438320297162272)
,p_page_template_id=>wwv_flow_imp.id(42437192798162273)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42438649299162272)
,p_page_template_id=>wwv_flow_imp.id(42437192798162273)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42438971984162272)
,p_page_template_id=>wwv_flow_imp.id(42437192798162273)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42439264260162272)
,p_page_template_id=>wwv_flow_imp.id(42437192798162273)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42439525498162272)
,p_page_template_id=>wwv_flow_imp.id(42437192798162273)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42439892449162272)
,p_page_template_id=>wwv_flow_imp.id(42437192798162273)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42440139409162272)
,p_page_template_id=>wwv_flow_imp.id(42437192798162273)
