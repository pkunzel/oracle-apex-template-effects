...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42502197075162232)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42502487066162232)
,p_plug_template_id=>wwv_flow_imp.id(42502197075162232)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42502774579162232)
,p_plug_template_id=>wwv_flow_imp.id(42502197075162232)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42503020536162232)
,p_plug_template_id=>wwv_flow_imp.id(42502197075162232)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42503335965162232)
,p_plug_template_id=>wwv_flow_imp.id(42502197075162232)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42503682028162232)
,p_plug_template_id=>wwv_flow_imp.id(42502197075162232)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42503901992162232)
,p_plug_template_id=>wwv_flow_imp.id(42502197075162232)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42504294831162231)
,p_plug_template_id=>wwv_flow_imp.id(42502197075162232)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42504505551162231)
,p_plug_template_id=>wwv_flow_imp.id(42502197075162232)
,p_name=>'Sub Regions'
