...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42456767421162257)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42457044777162257)
,p_plug_template_id=>wwv_flow_imp.id(42456767421162257)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42457379078162257)
,p_plug_template_id=>wwv_flow_imp.id(42456767421162257)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42457628471162257)
,p_plug_template_id=>wwv_flow_imp.id(42456767421162257)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42457966658162257)
,p_plug_template_id=>wwv_flow_imp.id(42456767421162257)
,p_name=>'Sub Regions'
