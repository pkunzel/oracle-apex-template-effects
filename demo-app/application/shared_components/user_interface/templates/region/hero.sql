...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42498673866162234)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42498951737162234)
,p_plug_template_id=>wwv_flow_imp.id(42498673866162234)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42499273384162234)
,p_plug_template_id=>wwv_flow_imp.id(42498673866162234)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42499520537162233)
,p_plug_template_id=>wwv_flow_imp.id(42498673866162234)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42499809667162233)
,p_plug_template_id=>wwv_flow_imp.id(42498673866162234)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42500133021162233)
,p_plug_template_id=>wwv_flow_imp.id(42498673866162234)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
