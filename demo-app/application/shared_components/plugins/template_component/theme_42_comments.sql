...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(42615071084162087)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1842500477567193801)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42615577716162083)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42615810996162083)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42616198797162082)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42616446981162082)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42616795321162082)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(42621430105162076)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1842500477567193801)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42617088853162081)
,p_plugin_attribute_id=>wwv_flow_imp.id(42616795321162082)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42617400518162081)
,p_plugin_attribute_id=>wwv_flow_imp.id(42616795321162082)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42617884445162080)
,p_plugin_attribute_id=>wwv_flow_imp.id(42616795321162082)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42618258785162080)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(42616795321162082)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42618570608162080)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42618810364162079)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42619132644162079)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42619465820162078)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42619807679162078)
,p_plugin_attribute_id=>wwv_flow_imp.id(42619465820162078)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42620290032162077)
,p_plugin_attribute_id=>wwv_flow_imp.id(42619465820162078)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42620658004162077)
,p_plugin_attribute_id=>wwv_flow_imp.id(42619465820162078)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42621046655162076)
,p_plugin_attribute_id=>wwv_flow_imp.id(42619465820162078)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42621430105162076)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42621776669162076)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42622071459162075)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42622386521162075)
,p_plugin_attribute_id=>wwv_flow_imp.id(42622071459162075)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42622720119162075)
,p_plugin_attribute_id=>wwv_flow_imp.id(42622071459162075)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42623154389162074)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1842633145000295304)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1842632553495287847)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1842688177165269726)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1842840394878140497)
,p_plugin_id=>wwv_flow_imp.id(42615071084162087)
