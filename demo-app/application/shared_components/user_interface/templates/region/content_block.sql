...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42484280956162241)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42484593859162241)
,p_plug_template_id=>wwv_flow_imp.id(42484280956162241)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42484810162162241)
,p_plug_template_id=>wwv_flow_imp.id(42484280956162241)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42485140461162241)
,p_plug_template_id=>wwv_flow_imp.id(42484280956162241)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42485480985162241)
,p_plug_template_id=>wwv_flow_imp.id(42484280956162241)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42485794447162241)
,p_plug_template_id=>wwv_flow_imp.id(42484280956162241)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42486030837162241)
,p_plug_template_id=>wwv_flow_imp.id(42484280956162241)
,p_name=>'Sub Regions'
