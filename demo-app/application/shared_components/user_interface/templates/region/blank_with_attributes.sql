...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42455381547162258)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42455603940162258)
,p_plug_template_id=>wwv_flow_imp.id(42455381547162258)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42455994550162258)
,p_plug_template_id=>wwv_flow_imp.id(42455381547162258)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42456252781162257)
,p_plug_template_id=>wwv_flow_imp.id(42455381547162258)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42456528130162257)
,p_plug_template_id=>wwv_flow_imp.id(42455381547162258)
,p_name=>'Sub Regions'
