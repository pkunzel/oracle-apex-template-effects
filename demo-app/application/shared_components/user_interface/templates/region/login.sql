...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42516762852162226)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42517041285162226)
,p_plug_template_id=>wwv_flow_imp.id(42516762852162226)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42517306240162226)
,p_plug_template_id=>wwv_flow_imp.id(42516762852162226)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42517649681162226)
,p_plug_template_id=>wwv_flow_imp.id(42516762852162226)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42517953412162225)
,p_plug_template_id=>wwv_flow_imp.id(42516762852162226)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42518210537162225)
,p_plug_template_id=>wwv_flow_imp.id(42516762852162226)
,p_name=>'Sub Regions'
