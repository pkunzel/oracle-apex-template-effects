...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(42597166557162154)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42597461586162133)
,p_plugin_id=>wwv_flow_imp.id(42597166557162154)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42597725401162129)
,p_plugin_attribute_id=>wwv_flow_imp.id(42597461586162133)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42598122191162128)
,p_plugin_attribute_id=>wwv_flow_imp.id(42597461586162133)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42598540266162128)
,p_plugin_attribute_id=>wwv_flow_imp.id(42597461586162133)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42598992356162127)
,p_plugin_id=>wwv_flow_imp.id(42597166557162154)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(42597461586162133)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42599296806162126)
,p_plugin_id=>wwv_flow_imp.id(42597166557162154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42599593449162126)
,p_plugin_id=>wwv_flow_imp.id(42597166557162154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42599867084162125)
,p_plugin_id=>wwv_flow_imp.id(42597166557162154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42600171914162125)
,p_plugin_id=>wwv_flow_imp.id(42597166557162154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42600490944162125)
,p_plugin_attribute_id=>wwv_flow_imp.id(42600171914162125)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42600838866162124)
,p_plugin_attribute_id=>wwv_flow_imp.id(42600171914162125)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42601231753162124)
,p_plugin_attribute_id=>wwv_flow_imp.id(42600171914162125)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42601635626162124)
,p_plugin_attribute_id=>wwv_flow_imp.id(42600171914162125)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42602001212162123)
,p_plugin_id=>wwv_flow_imp.id(42597166557162154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42602348609162123)
,p_plugin_attribute_id=>wwv_flow_imp.id(42602001212162123)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42602776460162122)
,p_plugin_attribute_id=>wwv_flow_imp.id(42602001212162123)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42603114491162122)
,p_plugin_attribute_id=>wwv_flow_imp.id(42602001212162123)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42603534935162122)
,p_plugin_attribute_id=>wwv_flow_imp.id(42602001212162123)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42603987966162121)
,p_plugin_attribute_id=>wwv_flow_imp.id(42602001212162123)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42604389966162121)
,p_plugin_attribute_id=>wwv_flow_imp.id(42602001212162123)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42604747665162121)
,p_plugin_attribute_id=>wwv_flow_imp.id(42602001212162123)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42605140623162120)
,p_plugin_id=>wwv_flow_imp.id(42597166557162154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1842647971839275899)
,p_plugin_id=>wwv_flow_imp.id(42597166557162154)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
