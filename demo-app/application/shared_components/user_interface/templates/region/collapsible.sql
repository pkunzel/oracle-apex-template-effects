...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42488884239162239)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42489146152162239)
,p_plug_template_id=>wwv_flow_imp.id(42488884239162239)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42489454597162239)
,p_plug_template_id=>wwv_flow_imp.id(42488884239162239)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42489740796162239)
,p_plug_template_id=>wwv_flow_imp.id(42488884239162239)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42490099888162239)
,p_plug_template_id=>wwv_flow_imp.id(42488884239162239)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42490321333162239)
,p_plug_template_id=>wwv_flow_imp.id(42488884239162239)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42490638902162238)
,p_plug_template_id=>wwv_flow_imp.id(42488884239162239)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42490989515162238)
,p_plug_template_id=>wwv_flow_imp.id(42488884239162239)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42491215128162238)
,p_plug_template_id=>wwv_flow_imp.id(42488884239162239)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42491547297162238)
,p_plug_template_id=>wwv_flow_imp.id(42488884239162239)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42491891584162238)
,p_plug_template_id=>wwv_flow_imp.id(42488884239162239)
,p_name=>'Sub Regions'
