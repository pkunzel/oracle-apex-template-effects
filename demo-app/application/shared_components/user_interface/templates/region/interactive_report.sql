...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42512128202162228)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42512432554162228)
,p_plug_template_id=>wwv_flow_imp.id(42512128202162228)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42512787299162228)
,p_plug_template_id=>wwv_flow_imp.id(42512128202162228)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42513085950162228)
,p_plug_template_id=>wwv_flow_imp.id(42512128202162228)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42513309523162228)
,p_plug_template_id=>wwv_flow_imp.id(42512128202162228)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42513645034162227)
,p_plug_template_id=>wwv_flow_imp.id(42512128202162228)
,p_name=>'Sub Regions'
