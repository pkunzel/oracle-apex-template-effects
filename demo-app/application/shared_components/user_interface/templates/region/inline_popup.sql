...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42506797935162230)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42507043200162230)
,p_plug_template_id=>wwv_flow_imp.id(42506797935162230)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42507374301162230)
,p_plug_template_id=>wwv_flow_imp.id(42506797935162230)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42507618466162230)
,p_plug_template_id=>wwv_flow_imp.id(42506797935162230)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42507925763162230)
,p_plug_template_id=>wwv_flow_imp.id(42506797935162230)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42508277644162230)
,p_plug_template_id=>wwv_flow_imp.id(42506797935162230)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42508579623162229)
,p_plug_template_id=>wwv_flow_imp.id(42506797935162230)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42508834794162229)
,p_plug_template_id=>wwv_flow_imp.id(42506797935162230)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42509161606162229)
,p_plug_template_id=>wwv_flow_imp.id(42506797935162230)
,p_name=>'Sub Regions'
