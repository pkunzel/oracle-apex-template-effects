...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(42429776504162277)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42430046014162277)
,p_page_template_id=>wwv_flow_imp.id(42429776504162277)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42430359380162277)
,p_page_template_id=>wwv_flow_imp.id(42429776504162277)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42430684641162277)
,p_page_template_id=>wwv_flow_imp.id(42429776504162277)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42430975258162276)
,p_page_template_id=>wwv_flow_imp.id(42429776504162277)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42431206846162276)
,p_page_template_id=>wwv_flow_imp.id(42429776504162277)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42431506027162276)
,p_page_template_id=>wwv_flow_imp.id(42429776504162277)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42431888840162276)
,p_page_template_id=>wwv_flow_imp.id(42429776504162277)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42432133037162276)
,p_page_template_id=>wwv_flow_imp.id(42429776504162277)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42432430389162275)
,p_page_template_id=>wwv_flow_imp.id(42429776504162277)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42432791898162275)
,p_page_template_id=>wwv_flow_imp.id(42429776504162277)
