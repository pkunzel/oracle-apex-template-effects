...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(42519257723162225)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42519537495162225)
,p_plug_template_id=>wwv_flow_imp.id(42519257723162225)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42519864725162225)
,p_plug_template_id=>wwv_flow_imp.id(42519257723162225)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42520177691162224)
,p_plug_template_id=>wwv_flow_imp.id(42519257723162225)
,p_name=>'Sub Regions'
