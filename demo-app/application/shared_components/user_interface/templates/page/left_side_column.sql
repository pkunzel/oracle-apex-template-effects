...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(42422368285162281)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42422618436162281)
,p_page_template_id=>wwv_flow_imp.id(42422368285162281)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42422980248162280)
,p_page_template_id=>wwv_flow_imp.id(42422368285162281)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42423239158162280)
,p_page_template_id=>wwv_flow_imp.id(42422368285162281)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42423531310162280)
,p_page_template_id=>wwv_flow_imp.id(42422368285162281)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42423892654162280)
,p_page_template_id=>wwv_flow_imp.id(42422368285162281)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42424134365162280)
,p_page_template_id=>wwv_flow_imp.id(42422368285162281)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42424498338162280)
,p_page_template_id=>wwv_flow_imp.id(42422368285162281)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42424785482162280)
,p_page_template_id=>wwv_flow_imp.id(42422368285162281)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42425047389162280)
,p_page_template_id=>wwv_flow_imp.id(42422368285162281)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42425341648162280)
,p_page_template_id=>wwv_flow_imp.id(42422368285162281)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(42425638302162279)
,p_page_template_id=>wwv_flow_imp.id(42422368285162281)
